...
public class AgreeSet {
  ...
  public static List<AgreeSet> calculateAgreeSets(StrippedPartition partitions) {
    ...
    for (OpenBitSet bits : max) {
      List<EquivalenceClass> intersections = new LinkedList<EquivalenceClass>();
      Integer currentBit, lastBit = 0;
      List<EquivalenceClass> toIntersect = new LinkedList<EquivalenceClass>();
